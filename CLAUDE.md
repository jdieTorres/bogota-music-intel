...
Datos en base al 2026-08-28 (recontar con una consulta, no citar de memoria): **52 eventos, 9 salas**, los 52 clasificados. Reparto: 3 no son música, 5 fiestas, **7 locales**, 36 internacionales, 1 sin origen resuelto (`El plan de la mariposa`). En pantalla: **40 conciertos en 9 salas** y **3 fiestas próximas en 2 salas** (más THE JAZZ ROOM, que la sala publica sin fecha y sale bajo "Fecha por confirmar"). La diferencia entre lo que hay en base y lo que se ve son los duplicados que se unifican entre fuentes.
