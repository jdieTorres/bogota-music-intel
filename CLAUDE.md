...
- `services/api/bogota_music_intel/artistas_locales.py` — origen de artistas que MusicBrainz no cubre. **Los 8 eventos que siguen sin origen al 2026-08-27**: El Kalvo, PABLOPABLO, Ancestral Beats, Slaughter to Prevail y El plan de la mariposa (los cinco existen en MusicBrainz **sin país**); Mukangu / Atake Mapale / Los Yoryis (no está); `'Fuera de sí' por Jenny Ocampo y Santiago Botero`; y `Laura & Brenda`, que se queda sin resolver a propósito — la página de Movistar Arena no dice quiénes son. Ya cargado: Todo Copas.
...
Datos en base al 2026-08-27 (recontar con una consulta, no citar de memoria): **58 eventos, 9 salas**, los 58 clasificados. Reparto: 6 fuera de cartelera, 5 fiestas, 5 locales, 34 internacionales, 8 sin origen resuelto. En pantalla: **44 conciertos en 9 salas** y **3 fiestas próximas en 2 salas** (más THE JAZZ ROOM, que la sala publica sin fecha y sale bajo "Fecha por confirmar"). La diferencia entre lo que hay en base y lo que se ve son los duplicados que se unifican entre fuentes.
